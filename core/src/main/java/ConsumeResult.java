...
public class ConsumeResult {
    ...
    public String toString() {
        if (consumed) {
            return String.format("ConsumeResult{consumed=true, requested=%d, remaining=%d, nextRefill=%s}",
                    requestedTokens, remainingTokens, nextRefillTime);
        } else {
            return String.format("ConsumeResult{consumed=false, requested=%d, remaining=%d, waitTime=%s, reason='%s'}",
