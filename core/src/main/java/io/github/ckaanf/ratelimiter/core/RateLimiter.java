 ...
 * <pre>{@code
 * // 설정 생성
 * io.github.ckaanf.ratelimiter.core.RateLimiterConfig config = new io.github.ckaanf.ratelimiter.core.RateLimiterConfig(
 *     "api-user-123",
 ...
 *
 * // Rate Limiter 생성
 * io.github.ckaanf.ratelimiter.core.RateLimiter limiter = io.github.ckaanf.ratelimiter.core.RateLimiterRegistry.getInstance().getRateLimiter(config);
 *
